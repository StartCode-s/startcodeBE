...
<body>
   ...
   :root {
      --pixel-size: 5px;
        ...
        .npc {
            transform: translate3d(100px, 370px, 0);
        ...
        .npc[facing="right"] .npc_spritesheet {
            background-position-y: calc(var(--pixel-size) * -32);
        }

        .npc[facing="up"] .npc_spritesheet {
            background-position-y: calc(var(--pixel-size) * -64);
        }

        .npc[facing="left"] .npc_spritesheet {
            background-position-y: calc(var(--pixel-size) * -96);
        }
    ...
    <script>
        ...
        document.querySelector(".dpad-right").addEventListener("touchstart", (e) => handleDpadPress(directions.right,
            true));
